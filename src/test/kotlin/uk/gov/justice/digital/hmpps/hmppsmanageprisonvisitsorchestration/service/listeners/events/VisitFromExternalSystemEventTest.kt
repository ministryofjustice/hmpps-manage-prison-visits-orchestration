...
class VisitFromExternalSystemEventTest {
  ...
  fun `get a CreateVisitFromExternalSystemDto from message attributes`() {
    ...
    var createVisitFromExternalSystemDto: CreateVisitFromExternalSystemDto? = null
    assertDoesNotThrow {
      createVisitFromExternalSystemDto = visitFromExternalSystemEvent.toCreateVisitFromExternalSystemDto()
    }
