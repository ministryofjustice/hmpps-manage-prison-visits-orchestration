...
class VisitSessionsCapacityTest : IntegrationTestBase() {
  ...
  fun `when session capacity exists open and closed counts are returned`() {
    ...
    // When
    val responseSpec = callVisitsSessionsCapacity(webTestClient, prisonCode, sessionDate, sessionStartTime, sessionEndTime, sessionCapacityDto, roleVisitOrchestrastionHttpHeaders)
