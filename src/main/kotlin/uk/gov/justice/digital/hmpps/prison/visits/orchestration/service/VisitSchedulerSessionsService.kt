...
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.client.AlertsApiClient
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.client.PrisonApiClient
...
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.client.WhereAboutsApiClient
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.dto.alerts.api.enums.PrisonerSupportedAlertCodeType
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.dto.request.review.PrisonerRestrictionsForReview
...
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.dto.visit.scheduler.IndefiniteDateRange
...
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.dto.visit.scheduler.enums.SessionRestriction.CLOSED
...
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.dto.visit.scheduler.sessions.PrisonerScheduledEventDto
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.dto.visit.scheduler.sessions.SessionsAndScheduleDto
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.dto.visit.scheduler.sessions.VisitSessionV2Dto
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.dto.visit.scheduler.sessions.VisitSessionsAndScheduleDto
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.dto.whereabouts.ScheduledEventDto
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.exception.DateRangeNotFoundException
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.exception.NotFoundException
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.service.PrisonService.Companion.logger
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.utils.DateRangeIterator
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.utils.DateUtils
