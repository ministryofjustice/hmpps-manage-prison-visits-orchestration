...
class CountVisitNotificationTest : IntegrationTestBase() {
  ...
  fun `when notification count is requested for all prisons`() {
    ...
    // When
    val responseSpec = callCountVisitNotification(webTestClient, roleVisitOrchestrastionHttpHeaders)
  ...
  fun `when notification count is requested for a prisons`() {
    ...
    // When
    val responseSpec = callCountVisitNotificationForAPrison(webTestClient, prisonCode, roleVisitOrchestrastionHttpHeaders)
