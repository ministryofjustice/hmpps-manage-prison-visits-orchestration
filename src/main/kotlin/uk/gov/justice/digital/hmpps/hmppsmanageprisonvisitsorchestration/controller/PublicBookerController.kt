...
class PublicBookerController(
  ...
  ): PermittedVisitorForPermittedPrisonerBookerDto = publicBookerService.registerVisitorForBookerPrisoner(bookerReference, prisonerId, registerVisitorForBookerPrisonerDto)
