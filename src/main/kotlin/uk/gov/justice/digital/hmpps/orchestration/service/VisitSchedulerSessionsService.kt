...
import uk.gov.justice.digital.hmpps.orchestration.client.AlertsApiClient
...
import uk.gov.justice.digital.hmpps.orchestration.dto.alerts.api.enums.PrisonerSupportedAlertCodeType
import uk.gov.justice.digital.hmpps.orchestration.dto.request.review.PrisonerRestrictionsForReview
import uk.gov.justice.digital.hmpps.orchestration.dto.request.review.VisitorRestrictionsForReview
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.AvailableVisitSessionDto
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.AvailableVisitSessionRestrictionDto
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.DateRange
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.IndefiniteDateRange
...
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.enums.SessionRestriction.OPEN
...
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.sessions.PrisonerScheduledEventDto
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.sessions.SessionsAndScheduleDto
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.sessions.VisitSessionV2Dto
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.sessions.VisitSessionsAndScheduleDto
import uk.gov.justice.digital.hmpps.orchestration.dto.whereabouts.ScheduledEventDto
import uk.gov.justice.digital.hmpps.orchestration.exception.DateRangeNotFoundException
import uk.gov.justice.digital.hmpps.orchestration.exception.NotFoundException
import uk.gov.justice.digital.hmpps.orchestration.service.PrisonService.Companion.logger
import uk.gov.justice.digital.hmpps.orchestration.utils.DateRangeIterator
import uk.gov.justice.digital.hmpps.orchestration.utils.DateUtils
