...
class VisitSchedulerService(
  ...
  fun processPersonRestrictionDeleted(info: PersonRestrictionDeletedInfo) {
    visitSchedulerClient.processPersonRestrictionDeleted(PersonRestrictionDeletedNotificationDto(info))
  }
