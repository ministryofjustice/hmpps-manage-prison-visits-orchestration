...
class AvailableVisitSessionsWithoutAppointmentsCheckTest : IntegrationTestBase() {
  ...
  fun `when visit sessions for parameters are available and no visitors are supplied`() {
    ...
    val prisonDto = createVisitSchedulerPrisonDto(prisonCode, active = true, maxTotalVisitors = 6, maxAdultVisitors = 3, maxChildVisitors = 3, policyNoticeDaysMin = 2, policyNoticeDaysMax = 28, adultAgeYears = 18)
