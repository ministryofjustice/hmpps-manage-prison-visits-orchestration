...
import uk.gov.justice.digital.hmpps.orchestration.client.ClientUtils.Companion.isUnprocessableEntityError
import uk.gov.justice.digital.hmpps.orchestration.client.PrisonerSearchClient.Companion.logger
import uk.gov.justice.digital.hmpps.orchestration.config.ApplicationValidationErrorResponse
...
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.AvailableVisitSessionDto
...
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.SessionCapacityDto
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.SessionScheduleDto
...
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.visitnotification.VisitNotificationsDto
...
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.visitor.VisitorLastApprovedDateRequestDto
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.visitor.VisitorLastApprovedDatesDto
import uk.gov.justice.digital.hmpps.orchestration.exception.ApplicationValidationException
