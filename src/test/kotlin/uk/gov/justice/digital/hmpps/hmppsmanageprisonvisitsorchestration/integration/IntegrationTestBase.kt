...
abstract class IntegrationTestBase {
  ...
  lateinit var roleVisitOrchestrastionHttpHeaders: (HttpHeaders) -> Unit
  ...
  @BeforeEach
  internal fun setUp() {
    roleVisitOrchestrastionHttpHeaders = setAuthorisation(roles = listOf("ROLE_VISITS_ORCHESTRATION_SERVICE"))
  }
