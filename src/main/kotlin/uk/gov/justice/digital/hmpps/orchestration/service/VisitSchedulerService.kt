...
import uk.gov.justice.digital.hmpps.orchestration.client.VisitBookingDetailsClient
import uk.gov.justice.digital.hmpps.orchestration.client.VisitSchedulerClient
import uk.gov.justice.digital.hmpps.orchestration.dto.builder.OrchestrationVisitDtoBuilder
import uk.gov.justice.digital.hmpps.orchestration.dto.orchestration.BookingOrchestrationRequestDto
...
import uk.gov.justice.digital.hmpps.orchestration.dto.orchestration.OrchestrationApproveRejectVisitRequestResponseDto
import uk.gov.justice.digital.hmpps.orchestration.dto.orchestration.OrchestrationVisitDto
import uk.gov.justice.digital.hmpps.orchestration.dto.orchestration.OrchestrationVisitNotificationsDto
import uk.gov.justice.digital.hmpps.orchestration.dto.orchestration.OrchestrationVisitRequestSummaryDto
import uk.gov.justice.digital.hmpps.orchestration.dto.orchestration.VisitBookingDetailsDto
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.ActionedByDto
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.ApproveVisitRequestBodyDto
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.BookingRequestDto
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.CancelVisitDto
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.IgnoreVisitNotificationsDto
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.RejectVisitRequestBodyDto
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.VisitDto
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.VisitRequestsCountDto
...
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.visitnotification.PrisonerRestrictionChangeNotificationDto
...
import uk.gov.justice.digital.hmpps.orchestration.service.listeners.events.additionalinfo.NonAssociationChangedInfo
import uk.gov.justice.digital.hmpps.orchestration.service.listeners.events.additionalinfo.PersonRestrictionUpsertedInfo
...
import uk.gov.justice.digital.hmpps.orchestration.service.listeners.events.additionalinfo.PrisonerReleasedInfo
import uk.gov.justice.digital.hmpps.orchestration.service.listeners.events.additionalinfo.PrisonerRestrictionChangeInfo
import uk.gov.justice.digital.hmpps.orchestration.service.listeners.events.additionalinfo.VisitorApprovedUnapprovedInfo
import uk.gov.justice.digital.hmpps.orchestration.service.listeners.events.additionalinfo.VisitorRestrictionUpsertedInfo
import uk.gov.justice.digital.hmpps.orchestration.service.listeners.notifiers.NonAssociationDomainEventType
...
class VisitSchedulerService(
  ...
  fun processCourtVideoAppointmentCreated(info: CourtVideoAppointmentInfo) {
