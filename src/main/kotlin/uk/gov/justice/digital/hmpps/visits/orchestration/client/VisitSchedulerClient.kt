...
import uk.gov.justice.digital.hmpps.visits.orchestration.client.ClientUtils.Companion.isNotFoundError
import uk.gov.justice.digital.hmpps.visits.orchestration.client.ClientUtils.Companion.isUnprocessableEntityError
import uk.gov.justice.digital.hmpps.visits.orchestration.client.PrisonerSearchClient.Companion.logger
import uk.gov.justice.digital.hmpps.visits.orchestration.config.ApplicationValidationErrorResponse
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.RestPage
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.ApproveVisitRequestBodyDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.AvailableVisitSessionDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.BookingRequestDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.CancelVisitDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.CreateVisitFromExternalSystemDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.DateRange
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.EventAuditDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.IgnoreVisitNotificationsDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.RejectVisitRequestBodyDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.SessionCapacityDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.SessionScheduleDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.UpdateVisitFromExternalSystemDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.VisitDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.VisitPreviewDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.VisitRequestSummaryDto
...
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.enums.SessionRestriction
...
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.visitnotification.NotificationCountDto
...
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.visitnotification.PrisonerRestrictionChangeNotificationDto
...
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.visitor.VisitorLastApprovedDateRequestDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.visitor.VisitorLastApprovedDatesDto
import uk.gov.justice.digital.hmpps.visits.orchestration.exception.ApplicationValidationException
import uk.gov.justice.digital.hmpps.visits.orchestration.exception.NotFoundException
import uk.gov.justice.digital.hmpps.visits.orchestration.filter.VisitSearchRequestFilter
