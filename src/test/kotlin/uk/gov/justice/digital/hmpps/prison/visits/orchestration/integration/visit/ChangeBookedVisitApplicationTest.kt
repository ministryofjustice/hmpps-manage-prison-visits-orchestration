...
import uk.gov.justice.digital.hmpps.prison.visits.orchestration.dto.visit.scheduler.enums.ApplicationStatus.ACCEPTED
...
class ChangeBookedVisitApplicationTest : IntegrationTestBase() {
  ...
  fun `when change a booked visit application is successful then OK status is returned`() {
    ...
    val applicationDto = createApplicationDto(reference = reference, prisonerId = prisonerId, applicationStatus = ACCEPTED)
