...
data class PrisonVisitorRequestListEntryDto(
  ...
  constructor(prisonVisitorRequestDto: PrisonVisitorRequestDto, prisonerInfo: AttributeSearchPrisonerDto?) : this(
    ...
    bookerReference = prisonVisitorRequestDto.bookerReference,
    bookerEmail = prisonVisitorRequestDto.bookerEmail,
    prisonerId = prisonVisitorRequestDto.prisonerId,
    prisonerFirstName = prisonerInfo?.firstName ?: "Unknown",
    prisonerLastName = prisonerInfo?.lastName ?: "Unknown",
    firstName = prisonVisitorRequestDto.firstName,
