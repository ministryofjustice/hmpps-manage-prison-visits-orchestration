...
class VisitSchedulerService(
  ...
  fun processPrisonerAlertUpdated(info: PrisonerAlertUpsertedInfo, description: String?) {
    val prisonerAlertUpdatedNotification = PrisonerAlertUpsertedNotificationDto(
      info,
  ...
  fun processPrisonerAlertDeleted(info: PrisonerAlertUpsertedInfo, description: String?) {
    val prisonerAlertDeletedNotification = PrisonerAlertUpsertedNotificationDto(
      info,
