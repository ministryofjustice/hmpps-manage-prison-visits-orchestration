...
import uk.gov.justice.digital.hmpps.visits.orchestration.client.PrisonApiClient
...
import uk.gov.justice.digital.hmpps.visits.orchestration.client.WhereAboutsApiClient
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.alerts.api.enums.PrisonerSupportedAlertCodeType
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.request.review.PrisonerRestrictionsForReview
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.request.review.VisitorRestrictionsForReview
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.AvailableVisitSessionDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.AvailableVisitSessionRestrictionDto
...
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.enums.SessionRestriction.CLOSED
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.enums.SessionRestriction.OPEN
...
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.prisons.IsExcludeDateDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.sessions.PrisonerScheduledEventDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.sessions.SessionsAndScheduleDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.sessions.VisitSessionV2Dto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.visit.scheduler.sessions.VisitSessionsAndScheduleDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.whereabouts.ScheduledEventDto
import uk.gov.justice.digital.hmpps.visits.orchestration.exception.DateRangeNotFoundException
import uk.gov.justice.digital.hmpps.visits.orchestration.exception.NotFoundException
import uk.gov.justice.digital.hmpps.visits.orchestration.service.PrisonService.Companion.logger
import uk.gov.justice.digital.hmpps.visits.orchestration.utils.DateRangeIterator
import uk.gov.justice.digital.hmpps.visits.orchestration.utils.DateUtils
  ...
  fun getVisitSessionsAndSchedule(
    ...
    val prisonerSchedules =
      try {
        ...
        LOG.info("An exception occurred when retrieving schedule data for prisonerId - $prisonerId, returning an empty list", e)
