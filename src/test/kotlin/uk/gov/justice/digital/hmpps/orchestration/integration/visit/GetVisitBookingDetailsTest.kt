...
import uk.gov.justice.digital.hmpps.orchestration.controller.GET_VISIT_FULL_DETAILS_BY_VISIT_REFERENCE
import uk.gov.justice.digital.hmpps.orchestration.dto.alerts.api.AlertDto
...
import uk.gov.justice.digital.hmpps.orchestration.dto.orchestration.PrisonerDetailsDto
import uk.gov.justice.digital.hmpps.orchestration.dto.orchestration.VisitBookingDetailsDto
import uk.gov.justice.digital.hmpps.orchestration.dto.orchestration.VisitContactDto
import uk.gov.justice.digital.hmpps.orchestration.dto.orchestration.VisitNotificationDto
import uk.gov.justice.digital.hmpps.orchestration.dto.orchestration.VisitorDetailsDto
import uk.gov.justice.digital.hmpps.orchestration.dto.prison.api.OffenderRestrictionDto
import uk.gov.justice.digital.hmpps.orchestration.dto.prison.api.OffenderRestrictionsDto
...
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.enums.ApplicationMethodType.EMAIL
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.enums.ApplicationMethodType.NOT_APPLICABLE
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.enums.EventAuditType.BOOKED_VISIT
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.enums.EventAuditType.CANCELLED_VISIT
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.enums.EventAuditType.PRISONER_RESTRICTION_CHANGE_EVENT
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.enums.EventAuditType.UPDATED_VISIT
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.enums.NotificationEventAttributeType
...
import uk.gov.justice.digital.hmpps.orchestration.dto.visit.scheduler.enums.UserType.SYSTEM
...
class GetVisitBookingDetailsTest : IntegrationTestBase() {
  ...
  private fun assertVisitDetails(
    ...
    assertThat(visitBookingDetailsDto.visitSubStatus).isEqualTo(visitDto.visitSubStatus)
