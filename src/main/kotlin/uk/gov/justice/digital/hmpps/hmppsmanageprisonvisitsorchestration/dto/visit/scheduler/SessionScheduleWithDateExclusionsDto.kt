...
@Schema(description = "Session schedule with current or future date exclusions")
data class SessionScheduleWithDateExclusionsDto(
  @param:Schema(description = "Session schedule details that have current or future date exclusions", required = true)
