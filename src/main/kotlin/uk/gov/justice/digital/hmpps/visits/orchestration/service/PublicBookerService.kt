...
import uk.gov.justice.digital.hmpps.visits.orchestration.client.BookerAuditHistoryClient
import uk.gov.justice.digital.hmpps.visits.orchestration.client.BookerPrisonerInfoClient
...
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.booker.management.SocialContactsDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.booker.registry.AddVisitorToBookerPrisonerRequestDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.booker.registry.AuthDetailDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.booker.registry.BookerHistoryAuditDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.booker.registry.BookerPrisonerInfoDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.booker.registry.BookerPrisonerVisitorRequestDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.booker.registry.BookerReference
...
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.booker.registry.RegisterPrisonerForBookerDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.booker.registry.RegisterVisitorForBookerPrisonerDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.booker.registry.VisitorInfoDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.booker.registry.admin.BookerDetailedInfoDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.booker.registry.admin.BookerPrisonerDetailedInfoDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.booker.registry.admin.BookerSearchResultsDto
import uk.gov.justice.digital.hmpps.visits.orchestration.dto.booker.registry.admin.SearchBookerDto
...
import uk.gov.justice.digital.hmpps.visits.orchestration.exception.BookerAuthFailureException
import uk.gov.justice.digital.hmpps.visits.orchestration.exception.BookerPrisonerValidationException
...
class PublicBookerService(
  ...
  fun createAddVisitorRequest(bookerReference: String, prisonerNumber: String, addVisitorToBookerPrisonerRequestDto: AddVisitorToBookerPrisonerRequestDto) {
    logger.info("Entered PublicBookerService - addVisitorToBookerPrisoner - for booker {}, prisoner {}, addVisitorToBookerRequestDto {}", bookerReference, prisonerNumber, addVisitorToBookerPrisonerRequestDto)
